<template>
    ...
    >
      ...
      <!-- Menu drawer (semantically inside nav) -->
      <Transition name="drawer">
        <div class="v-app-nav__menu"
              v-if="showMenu().value"
        >
          <!-- Top Menu -->
          <div class="v-app-nav__menu__section v-app-nav__menu__section--top" v-if="useMenus().value?.topMenu?.length">
          ...
          <div class="v-app-nav__menu__section v-app-nav__menu__section--main">
            <template v-for="item of useMenus().value?.mainMenu" :key="item.url">
              <div class="v-app-nav__menu__group">
                <a v-if="item.openInNewTab" class="v-app-nav__menu__item" :href="item.url" target="_blank" rel="noopener noreferrer">
                  <img v-if="item.svgUrl" class="v-app-nav__menu__icon" :src="item.svgUrl" :alt="item.title">
                  <span v-else>{{ item.title }}</span>
                </a>
                ...
                <!-- Children (2nd level) -->
                <div v-if="item.children?.length" class="v-app-nav__menu__children">
                  <template v-for="child of item.children" :key="child.url">
                    <a v-if="child.openInNewTab" class="v-app-nav__menu__item v-app-nav__menu__item--child" :href="child.url" target="_blank" rel="noopener noreferrer">
                      <img v-if="child.svgUrl" class="v-app-nav__menu__icon" :src="child.svgUrl" :alt="child.title">
                      <span v-else>{{ child.title }}</span>
                    </a>
                    <nuxt-link v-else class="v-app-nav__menu__item v-app-nav__menu__item--child" :href="child.url">
                      <img v-if="child.svgUrl" class="v-app-nav__menu__icon" :src="child.svgUrl" :alt="child.title">
                      <span v-else>{{ child.title }}</span>
                    </nuxt-link>
                  </template>
          ...
          <!-- Bottom Menu -->
          <div class="v-app-nav__menu__section v-app-nav__menu__section--bottom" v-if="useMenus().value?.bottomMenu?.length">
          ...
          <!-- Footer Menu -->
          <div class="v-app-nav__menu__section v-app-nav__menu__section--footer">
